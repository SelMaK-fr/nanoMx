...
$delfiles = array(/* Dateien zum löschen */
    ...
    'admin/links/links.news-addstory.php',
    'admin/links/links.news-submissions.php',
    'admin/links/links.news-topics.php',
    'admin/links/links.submissions.php',
    'admin/modules/stories.php',
    $modpath . '.htaccess',
    $modpath . 'core/admin.newentries.php',
    $modpath . 'functions.php',
    $modpath . 'index.html',
    $modpath . 'language/index.html',
    ...
    $modpath . 'language/lang-danish.php',
    $modpath . 'language/lang-dutch.php',
    $modpath . 'language/lang-english.php',
    $modpath . 'language/lang-estonian.php',
    $modpath . 'language/lang-euskara.php',
    $modpath . 'language/lang-finnish.php',
    $modpath . 'language/lang-french.php',
    $modpath . 'language/lang-galego.php',
    $modpath . 'language/lang-german.php',
    $modpath . 'language/lang-german_du.php',
    ...
    $modpath . 'language/lang-turkish.php',
